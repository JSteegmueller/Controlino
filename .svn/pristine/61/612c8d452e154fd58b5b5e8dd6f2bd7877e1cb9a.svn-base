...
class ArduinoTimer
{
    ...
    unsigned long int waitMicrosToEvent;
  ...
  public:
    ...
    void setIntervalTimeMicroSec(unsigned long int intervalTimeMicroSec, unsigned int nTimes = ARDUINOTIMER_ENDLESS, unsigned char waitMicrosToEvent=65); 
