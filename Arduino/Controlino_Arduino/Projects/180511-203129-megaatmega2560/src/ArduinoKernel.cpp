#include "ArduinoKernel.h"  // Version 5 (Feb 2018)
#include <Arduino.h>
...
ArduinoKernel::ArduinoKernel()
{
  ...
  freieEvents              = new BitList(MAX_ANZAHL_EVENT_BYTES, 0);  // Mit Nullen fuellen 
...
void ArduinoKernel::setup()
{
  ...
  arduinoSetup(); // Hier können noch weitere Apps angemeldet werden
...
unsigned char ArduinoKernel::createNewEvent()
{
  ...
  event = freieEvents->getFirstBitindexThatIs_StartAtBit_getSuccess(0, 1, success); // Niemals Event NULL vergeben!
