...
class ArduinoKernel
{
  public:
    ...
    // Interrupts
    ///////////////////////////////////////////////
    virtual void arduinoEvent(int idEvent) = 0; // Wird von ArduinoKernel oder anderen Modulen aufgerufen, wenn ein Event passiert
...
///////////////////////////////////////////////
  ...
  private:
    ...
    virtual void arduinoSetup() = 0; //Erst hier sind Arduino-Befehle moeglich!
    virtual void arduinoLoop()  = 0; //Wird immer aufgerufen, wenn es nichts zu tun gibt. (Arduino_mini_Pro_15MHz: ca. 15000 mal pro sec)
